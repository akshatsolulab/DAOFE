  ...
  <div>
   <div className="mx-auto mt-10  text-white text-3xl font-bold max-w-2xl" style={{ width: "600px" }}>
    ...
    <div className="border max-w-2xl mt-7 rounded-lg p-3" style={{ borderColor: "#2d2d2d" }}>
     <label htmlFor="email" className="block mt-3 mb-2 ml-5 mr-3 mx-auto max-w-2xl text-sm font-medium text-gray-400 ">
      To
     </label>
     <input
      type="email"
      ...
      className=" border bg-transparent mx-auto max-w-lg ml-5 mr-3 text-white text-sm rounded-full  focus:border-blue-500 block w-full p-2.5  border-gray-600 placeholder-gray-400  focus:ring-blue-500 "
     ...
     {!Loading ? (
      <button
       className="bg-transparent border  max-w-lg ml-5 mr-3 mb-5 mt-4 mx-12 empty:3 px-12 py-1 rounded-full   font-medium text-white text-lg hover:bg-blue-600"
       style={{ borderColor: "#2d2d2d" }}
     ...
     <div>
      <a className="text-sm ml-10 hover:text-blue-600" href={`https://rinkeby.etherscan.io/tx/${Hash}`}>
       {Hash}
      </a>
     </div>
    </div>
